...
--                         FOREIGN KEY(FactCheckerUserID) REFERENCES FactChecker (UserID) ON DELETE CASCADE,
--                         FOREIGN KEY(NormalUserId) REFERENCES NormalUser (UserID) ON DELETE CASCADE,
--                         FOREIGN KEY(CommentsTimeStamp) REFERENCES Comments ON DELETE CASCADE
-- );
-- GRANT SELECT ON Verify TO PUBLIC;
-- INSERT INTO Verify VALUES ('7','1',2021-02-28 09:20:11, '1');
-- INSERT INTO Verify VALUES ('8','2', 2021-02-28 09:20:11, '1');
-- INSERT INTO Verify VALUES ('9', '3', 2021-02-28 09:20:11, '0');
-- INSERT INTO Verify VALUES ('10', '4', 2021-02-28 09:20:11, '1');
-- INSERT INTO Verify VALUES ('11', '5', 2021-02-28 09:20:11, '0');
--
--
-- create table Articles(
--                          ArticleURL  VARCHAR2(200) NOT NULL,
...
--
-- GRANT SELECT ON Comments TO PUBLIC;
-- INSERT INTO Comments VALUES ('1',2021-02-28 09:20:11, 'John Horgan may have done great things for BC but did not do enough to stop COVID19!!!! ', 3);
-- INSERT INTO Comments VALUES ('2', 2021-02-28 09:20:11, 'Jason Kenny is a racist! ', 1);
-- INSERT INTO Comments VALUES ('3', 2021-02-28 09:20:11, 'Ford is truly a good Politician he helps us to build the pool in the community! ', 7);
-- INSERT INTO Comments VALUES ('4', 2021-02-28 09:20:11, 'Scott Moe wants is one of few politicians who really wants to solve global warming. ', 7);
-- INSERT INTO Comments VALUES ('5', 2021-02-28 09:20:11, 'Iain Rankin has been wasting tax payer''s dollars on useless initiatives. ', 2);
--
-- CREATE TABLE PresetTags(
--                            Text   VARCHAR2(30),
--                            NegativeOrPositive INTEGER,
...
-- );
-- GRANT SELECT ON CommentsHasPresetTags TO PUBLIC;
-- INSERT INTO CommentsHasPresetTags VALUES ( 'John Horgan may have done great things for BC but did not do enough to stop COVID19!!!! ', 2021-02-28 09:20:11,'1');
-- INSERT INTO CommentsHasPresetTags VALUES ('Jason Kenny is a racist! ', 2021-02-28 09:20:11,'2');
-- INSERT INTO CommentsHasPresetTags VALUES ('Ford is truly a good Politician he helps us to build the pool in the community! ',2021-02-28 09:20:11, '3');
-- INSERT INTO CommentsHasPresetTags VALUES ('Scott Moe wants is one of few politicians who really wants to solve global warming. ',2021-02-28 09:20:11, '4');
-- INSERT INTO CommentsHasPresetTags VALUES ( 'Iain Rankin has been wasting tax payer''s dollars on useless initiatives. ',2021-02-28 09:20:11, '5');
--
-- -- TODO: Rating???
--
-- CREATE TABLE CountryOfBirth(
...
--                                CountryOfBirth VARCHAR2(30),
--                                PRIMARY KEY (FirstName, LastName),
--                                FOREIGN KEY (FirstName, LastName) REFERENCES Politician ON DELETE CASCADE
-- );
-- GRANT SELECT ON CountryOfBirth TO PUBLIC;
-- INSERT INTO CountryOfBirth VALUES ('Jason', 'Kenny', 'Canada');
-- INSERT INTO CountryOfBirth VALUES ('John', 'Horgan', 'Canada');
...
--                         PoliticalLeaning    VARCHAR2(50),
--                         PRIMARY KEY(PoliticalLeaningScore),
--                         FOREIGN KEY(PoliticalLeaningScore) REFERENCES Party ON DELETE CASCADE
--                             ON UPDATE CASCADE
-- );
-- GRANT SELECT ON Leaning TO PUBLIC;
-- INSERT INTO Leaning VALUES ('4', 'Right-Wing ');
...
-- INSERT INTO Video VALUES ('News Conference ', 'British Columbia Premier John Horgan speaks with reporters in Victoria – December 2, 2020 ', 'https://www.youtube.com/watch?v=5KTXAeVfz0Q ');
-- INSERT INTO Video VALUES ('Speech', 'Watch Saskatchewan Premier Scott Moe’s victory speech ',  'https://www.youtube.com/watch?v=3aUNAGfq458');
-- INSERT INTO Video VALUES ('News report  ','Doug Ford moves key ministers in major cabinet shuffle | Power & Politics ','https://www.youtube.com/watch?v=C9tRkoCD1Ws');
-- INSERT INTO Video VALUES ('escriptive video  ','Iain Rankin (Politician)', 'https://www.youtube.com/watch?v=Rb3qh2kdbT8 ');
--
-- CREATE TABLE Appearance(
--                            PoliticianId INTEGER,
